...
export const loyaltyData = [
  {
    ...
    "insights": "  Клиенты преимущественно молоды (средний возраст 38 лет) и совершают повседневные покупки. Основные траты приходятся на одежду, продукты, кафе и доставку еды. Средний чек и оборот на клиента невысокие, но частота операций стабильна."
  ...
  },
  {
    ...
    "insights": "Основные траты сосредоточены на одежде, ресторанах и путешествиях — показатель премиальных предпочтений. Частота транзакций (215) и оборот на клиента (2,78 млн ₸) заметно выше, чем у Silver. Высокая доля активности в крупных городах (Алматы, Астана) и онлайн-каналах."
  ...
  },
  {
    ...
    "insights": "Средний чек ниже, чем у Gold, но компенсируется объёмом и частотой (46 операций на клиента). Поведение преимущественно повседневное: покупки в супермаркетах, кафе, доставка еды и одежда. Клиенты используют карту как основной инструмент платежей"
